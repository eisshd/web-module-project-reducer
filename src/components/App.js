...
import { addMemory, applyNumber , changeOperation, clearTotal} from '../actions';
        ...
        <div className="col-md-12 d-flex justify-content-center">
          <form name="Cal">
            ...
            <div className="row">
              ...
              <CalcButton value={"MR"} onClick={memoryRecord}/>
